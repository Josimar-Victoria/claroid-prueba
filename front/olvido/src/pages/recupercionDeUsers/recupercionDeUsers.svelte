	...
	<div class="container">
		<Container class="justify-content-center align-items-center text-center">
			<Row class="align-items-center">
				<div class="logo">
					<img
					src="https://claroidecuador.s3.amazonaws.com/PNG/Vector.png"
					alt="Icon-logo-claro"
				/>
        </div>

				<div class="title">
					<h2 class="f-gray mt-4">Recuperar usuario</h2>
					<p class="subtitle">
								...
								<div class="col-md-4">
									...
									<div class="input-icon">
										...
										<span class="span-icon">
											...
											{:else if !selectedOptionError1 && selectedOption1 != ""}
									...
									<div class="col-md-4">
										<div class="input-icon">
											...
											<span class="span-icon">
												...
												{:else if !respuesta1Error && respuesta1 != ""}
													<i class="fas fa-check">
														<img src="https://claroidecuador.s3.amazonaws.com/PNG/FrameCorrectoInput_Icono.png" alt="">
													</i>
												{/if}
								...
								<div class="col-md-4">
									...
									<div class="input-icon">
										...
										<span class="span-icon">
											...
											{:else if !selectedOptionError2 && selectedOption2 != ""}
												<i class="fas fa-check">
													<img src="https://claroidecuador.s3.amazonaws.com/PNG/FrameCorrectoInput_Icono.png" alt="">
												</i>
											{/if}
									...
									<div class="col-md-4">
										<div class="input-icon">
											...
											<span class="span-icon">
												...
												{:else if !respuesta2Error && respuesta2 != ""}
													<i class="fas fa-check">
														<img src="https://claroidecuador.s3.amazonaws.com/PNG/FrameCorrectoInput_Icono.png" alt="">
													</i>
												{/if}
								...
								<div class="col-md-4">
									...
									<div class="input-icon">
										...
										<span class="span-icon">
											...
											{:else if !selectedOptionError3 && selectedOption3 != ""}
												<i class="fas fa-check">
													<img src="https://claroidecuador.s3.amazonaws.com/PNG/FrameCorrectoInput_Icono.png" alt="">
												</i>
											{/if}
									...
									<div class="col-md-4">
										<div class="input-icon">
											...
											<span class="span-icon">
												...
												{:else if !respuesta3Error && respuesta3 != ""}
													<i class="fas fa-check">
														<img src="https://claroidecuador.s3.amazonaws.com/PNG/FrameCorrectoInput_Icono.png" alt="">
													</i>
												{/if}
